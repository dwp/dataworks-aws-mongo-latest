data "local_file" "hadoop_lzo_jar" {
  filename = "emr/mongo_latest/files/llap/encryption/hadoop-lzo.jar"
}
...
data "local_file" "hadoop_lzo_0_4_19_jar" {
  filename = "emr/mongo_latest/files/llap/encryption/hadoop-lzo-0.4.19.jar"
}
...
data "local_file" "libgplcompression_a" {
  filename = "emr/mongo_latest/files/llap/encryption/libgplcompression.a"
}
...
data "local_file" "libgplcompression_so" {
  filename = "emr/mongo_latest/files/llap/encryption/libgplcompression.so"
}
...
data "local_file" "libgplcompression_so_0" {
  filename = "emr/mongo_latest/files/llap/encryption/libgplcompression.so.0"
}
...
data "local_file" "libgplcompression_so_0_0_0" {
  filename = "emr/mongo_latest/files/llap/encryption/libgplcompression.so.0.0.0"
}
