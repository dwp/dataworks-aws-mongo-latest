...
resource "aws_s3_object" "libgplcompression_so" {
  bucket = data.terraform_remote_state.common.outputs.config_bucket.id
...
resource "aws_s3_object" "libgplcompression_so_0" {
  bucket = data.terraform_remote_state.common.outputs.config_bucket.id
...
resource "aws_s3_object" "libgplcompression_so_0_0_0" {
  bucket = data.terraform_remote_state.common.outputs.config_bucket.id
