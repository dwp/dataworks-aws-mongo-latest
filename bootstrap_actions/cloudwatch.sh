    ...
    "logs_collected": {
      "files": {
        "collect_list": [
          ...
          {
            "file_path": "/var/log/mongo_latest/config_hcs.log",
            "log_group_name": "${cwa_bootstrap_loggrp_name}",
            "log_stream_name": "{instance_id}-config-hcs.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/mongo_latest/download_sql.log",
            "log_group_name": "${cwa_bootstrap_loggrp_name}",
          ...
          {
            "file_path": "/var/log/mongo_latest/executeUpdate*.log",
            "log_group_name": "${cwa_steps_loggrp_name}",
            "log_stream_name": "{instance_id}-executeUpdate.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/mongo_latest/executePublish*.log",
            "log_group_name": "${cwa_steps_loggrp_name}",
            "log_stream_name": "{instance_id}-executePublish.log",
            "timezone": "UTC"
          },
          {
